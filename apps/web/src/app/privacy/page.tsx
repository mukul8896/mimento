  ...
  return (
    <SiteShell title="Privacy policy" updated="24 September 2026">
      ...
      <PolicySection title="Cookies">
        <p>
          Functional cookies let this browser keep working on the surprise you are making, and keep
          a private management link you opened working. They are not used for advertising or
          tracking and are not shared with anyone. After clearing them, open your private management
          link again to manage a published surprise.
        </p>
      </PolicySection>
      ...
      <PolicySection title="How long we keep it">
        <p>
          ...
          An unfinished surprise (never published) is temporary: it is deleted automatically after
          30 days without being opened. A published surprise that nobody — neither you nor the
          people you sent it to — has opened for a year is deleted automatically; each visit keeps
          it for another year. The key in your browser stops working once everything it made has
          gone and it has not been used for a year. Deleting removes the content, photos and
          answers. Recipients&apos; answers are deleted automatically 180 days after they were
          given. Payment records are kept as long as the law requires for accounting, without the
          surprise&apos;s content.
        </p>
      </PolicySection>
